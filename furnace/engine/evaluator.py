...
class Evaluator(object):
    ...
    def run(self, model_path, model_indice, log_file, log_file_link):
        ...
        if '.pth' in model_indice:
            ...
            #          model_slice]
            #models = ["/TorchSemiSeg/CPS-50-1-16-single/snapshot/epoch-last.pth"]
            models = ["/TorchSemiSeg/CPS-50-1-16-single/max.pth"]
            #models = ["/model/1-16/snapshot/epoch-last.pth"]
        else:
